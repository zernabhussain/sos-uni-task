...
public class BaseFunctions {
	 ...
	 * > Ref 3 </a> </br>
	 * <a href="http://tracer.lcc.uma.es/problems/ackley/ackley.html" > Ref 4
	 * </a></br>
	 */
	public static class Ackley extends Problem {
		...
		/**
		 * Constructor for the Ackley function defined within the specified upper and
		 * lower bounds.
		 */
		public Ackley(int dimension) {
			super(dimension, new double[] { -1, 1 });
		}

		/**
		 * Constructor for the Ackley function defined within a hyper-cube.
		 */
		public Ackley(int dimension, double[] bounds) {
	 ...
	 * 
	 * References:
	 * <a href="http://clerc.maurice.free.fr/pso/Alpine/Alpine_Function.htm" > Ref 1
	 * </a>
	 */
	public static class Alpine extends Problem {
		/**
		 * Costructor for the Alpine function defined within the specified upper and
		 * lower bounds.
		 */
		public Alpine(int dimension) {
			super(dimension, new double[] { -10, 10 });
		}

		/**
		 * Costructor for the Alpine function defined within a hyper-cube.
		 */
		public Alpine(int dimension, double[] bounds) {
			super(dimension, bounds);
		}
	 ...
	 * Rosenbrock function.
	 * 
	 * References: <a href="http://en.wikipedia.org/wiki/Rosenbrock_function" > Ref
	 * 1 </a> <a href=
	 * "http://www-optima.amp.i.kyoto-u.ac.jp/member/student/hedar/Hedar_files/TestGO_files/Page2537.htm"
	 * > Ref 2 </a> <a href="http://mathworld.wolfram.com/RosenbrockFunction.html" >
	 * Ref 3 </a>
	 */
	public static class Rosenbrock extends Problem {
		/**
		 * Costructor for the sphere function defined within the specified upper and
		 * lower bounds.
		 */
		 ...
		 */
		public Rosenbrock(int dimension, double[] bounds) {
			super(dimension, bounds);
		}

		/**
		 * Costructor for the Rosenbrock function defined within particular decision
		 * space.
		 */
		public Rosenbrock(int dimension, double[][] bounds) {
			super(dimension, bounds);
	 ...
	 * > Ref 1 </a> <a href="http://www.it.lut.fi/ip/evo/functions/node2.html" > Ref
	 * 2 </a>
	 */
	...
	public static class Sphere extends Problem {
		...
		public Sphere(int dimension) {
			super(dimension, new double[] { -5.12, 5.12 });
		}

		/**
		 * Costructor for the Sphere function defined within a hyper-cube.
		 */
		public Sphere(int dimension, double[] bounds) {
			super(dimension, bounds);
		}
...
//					y += Math.exp(x[i]);
	 ...
	 * > Ref 1 </a> <a href="http://www.sfu.ca/~ssurjano/schwef.html" > Ref 2 </a>
	 */
	// UNCOMMENT AND COMPLETE THE CODE
	public static class Schwefel extends Problem {
		...
		public Schwefel(int dimension) {
			super(dimension, new double[] { -500, 500 });
		}

		/**
		 * Costructor for the Schwefel function defined within a hyper-cube.
		 */
		public Schwefel(int dimension, double[] bounds) {
			super(dimension, bounds);
		}

		/**
		 * Costructor for the Schwefel function defined within particular decision
		 * space.
		 */
		public Schwefel(int dimension, double[][] bounds) {
			super(dimension, bounds);
	 ...
	 * > Ref 1 </a> <a href="http://en.wikipedia.org/wiki/Rastrigin_function" > Ref
	 * 2 </a> <a href="http://www.mathworks.com/help/toolbox/gads/f14773.html" > Ref
	 * 3 </a>
	 */
	public static class Rastigin extends Problem {
		public Rastigin(int dimension) {
			super(dimension, new double[] { -5.12, 5.12 });
		}
		 ...
		 * Costructor for the Sphere function defined within a hyper-cube.
		 */
		public Rastigin(int dimension, double[] bounds) {
			super(dimension, bounds);
		}

		/**
		 * Costructor for the Rastigin function defined within particular decision
		 * space.
		 */
		public Rastigin(int dimension, double[][] bounds) {
			super(dimension, bounds);
	...
	public static class Michalewicz extends Problem {
		public Michalewicz(int dimension) {
			super(dimension, new double[] { 0, Math.PI });
		}

		/**
		 * Costructor for the Sphere function defined within a hyper-cube.
		 */
		public Michalewicz(int dimension, double[] bounds) {
			super(dimension, bounds);
		}
		...
		public double f(double[] x, int m) {
			...
			if (this.getDimension() != n) {
				...
				for (int i = 0; i < n; i++) {
					double newVal = Math.pow(Math.sin(i * Math.pow(x[i], 2) / Math.PI), (2 * m));
					sum += Math.sin(x[i]) * newVal;
				}
